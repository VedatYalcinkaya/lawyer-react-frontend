  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      setStatus({
        submitted: false,
        submitting: false,
        info: { error: true, msg: 'Mesajınız gönderilirken bir hata oluştu. Lütfen daha sonra tekrar deneyin.' }
      });
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        >
          <h3 className="text-2xl font-bold text-koyu-mavi mb-6">İletişim Bilgileri</h3>
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <a href="mailto:contact@emreokur.com" className="text-gray-600 hover:text-turkuaz transition-colors">
                  contact@emreokur.com
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                <h4 className="text-lg font-semibold text-koyu-mavi">Telefon</h4>
                <a href="tel:+905321234567" className="text-gray-600 hover:text-turkuaz transition-colors">
                  +90 (532) 123 45 67
                </a>
              </div>
            </div>
          ...
          <div className="mt-10">
            <h4 className="text-xl font-semibold text-koyu-mavi mb-4">Mesai Saatleri</h4>
            <ul className="space-y-2 text-gray-600">
              <li className="flex justify-between">
                <span>Pazartesi - Cuma:</span>
                <span className="text-koyu-mavi font-medium">09:00 - 18:00</span>
              </li>
              <li className="flex justify-between">
        ...
        >
          <h3 className="text-2xl font-bold text-koyu-mavi mb-6">Bir Mesaj Gönderin</h3>
          <div className="h-1 w-16 bg-gradient-to-r from-turkuaz to-acik-mavi rounded-full mb-8"></div>
          
          {/* Bildirimler */}
          {status.info.msg && (
            <motion.div 
              className={`mb-6 p-4 rounded-lg ${status.info.error ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'} flex items-start`}
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
            >
              <div className="mr-3 mt-0.5">
                {status.info.error ? <FiX className="text-red-500" /> : <FiCheck className="text-green-500" />}
              </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                <label htmlFor="name" className="block text-gray-700 font-medium mb-2">İsim</label>
                <input 
                  type="text" 
                  id="name" 
                  name="name" 
      ...
      >
        <iframe 
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d192698.95428304518!2d28.83662539442996!3d41.00520105145016!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14caa7040068086b%3A0xe1ccfe98bc01b0d0!2zxLBzdGFuYnVs!5e0!3m2!1str!2str!4v1679937770991!5m2!1str!2str" 
          width="100%" 
          height="100%" 
          style={{ border: 0 }} 
          allowFullScreen="" 
